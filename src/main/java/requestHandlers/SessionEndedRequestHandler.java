...
public interface SessionEndedRequestHandler extends RequestHandler {
     ...
     */
    boolean canHandle(HandlerInput input, SessionEndedRequest sessionEndedRequest);
     ...
     */
    Optional<Response> handle(HandlerInput input, SessionEndedRequest sessionEndedRequest);
