 ...
 */
public interface PlayCommandIssuedRequestHandler extends RequestHandler {

    /**
     * Returns true if the handler can dispatch the current request
     *
     * @param input input to the request handler
     * @param playCommandIssuedRequest PlayCommandIssuedRequest request
     * @return true if the handler is capable of handling the current request and/or state
     */
    boolean canHandle(HandlerInput input, PlayCommandIssuedRequest playCommandIssuedRequest);
     ...
     */
    Optional<Response> handle(HandlerInput input, PlayCommandIssuedRequest playCommandIssuedRequest);
    ...
    default Optional<Response> handle(HandlerInput handlerInput) {
        return handle(handlerInput, (PlayCommandIssuedRequest)handlerInput.getRequest());
    }
