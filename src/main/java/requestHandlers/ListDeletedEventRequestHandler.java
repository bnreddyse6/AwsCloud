...
public interface ListDeletedEventRequestHandler extends RequestHandler {
     ...
     */
    boolean canHandle(HandlerInput input, ListDeletedEventRequest listDeletedEventRequest);
     ...
     */
    Optional<Response> handle(HandlerInput input, ListDeletedEventRequest listDeletedEventRequest);
