 ...
 */
public interface ListUpdatedEventRequestHandler extends RequestHandler {

    /**
     * Returns true if the handler can dispatch the current request
     *
     * @param input input to the request handler
     * @param listUpdatedEventRequest ListUpdatedEventRequest request
     * @return true if the handler is capable of handling the current request and/or state
     */
    boolean canHandle(HandlerInput input, ListUpdatedEventRequest listUpdatedEventRequest);
     ...
     */
    Optional<Response> handle(HandlerInput input, ListUpdatedEventRequest listUpdatedEventRequest);
    ...
    default Optional<Response> handle(HandlerInput handlerInput) {
        return handle(handlerInput, (ListUpdatedEventRequest)handlerInput.getRequest());
    }
