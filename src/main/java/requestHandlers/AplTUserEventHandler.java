 ...
 */
public interface AplTUserEventHandler extends RequestHandler {
     ...
     */
    boolean canHandle(HandlerInput input, UserEvent userEvent);
     ...
     */
    Optional<Response> handle(HandlerInput input, UserEvent userEvent);
