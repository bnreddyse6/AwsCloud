...
public interface ListItemsCreatedEventRequestHandler extends RequestHandler {
     ...
     * @param listItemsCreatedEventRequest ListItemsCreatedEventRequest request
     * @return true if the handler is capable of handling the current request and/or state
     */
    boolean canHandle(HandlerInput input, ListItemsCreatedEventRequest listItemsCreatedEventRequest);
     ...
     */
    Optional<Response> handle(HandlerInput input, ListItemsCreatedEventRequest listItemsCreatedEventRequest);
