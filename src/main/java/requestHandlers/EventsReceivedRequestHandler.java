...
import com.amazon.ask.model.interfaces.customInterfaceController.EventsReceivedRequest;
...
public interface EventsReceivedRequestHandler extends RequestHandler {
     ...
     */
    boolean canHandle(HandlerInput input, EventsReceivedRequest eventsReceivedRequest);
     ...
     */
    Optional<Response> handle(HandlerInput input, EventsReceivedRequest eventsReceivedRequest);
