 ...
 */
public interface PermissionChangedRequestHandler extends RequestHandler {

    /**
     * Returns true if the handler can dispatch the current request
     *
     * @param input input to the request handler
     * @param permissionChangedRequest PermissionChangedRequest request
     * @return true if the handler is capable of handling the current request and/or state
     */
    boolean canHandle(HandlerInput input, PermissionChangedRequest permissionChangedRequest);
     ...
     */
    Optional<Response> handle(HandlerInput input, PermissionChangedRequest permissionChangedRequest);
    ...
    default Optional<Response> handle(HandlerInput handlerInput) {
        return handle(handlerInput, (PermissionChangedRequest)handlerInput.getRequest());
    }
