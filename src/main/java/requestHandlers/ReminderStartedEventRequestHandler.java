...
public interface ReminderStartedEventRequestHandler extends RequestHandler {
     ...
     */
    boolean canHandle(HandlerInput input, ReminderStartedEventRequest reminderStartedEventRequest);
     ...
     */
    Optional<Response> handle(HandlerInput input, ReminderStartedEventRequest reminderStartedEventRequest);
