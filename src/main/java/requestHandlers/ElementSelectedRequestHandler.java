 ...
 */
public interface ElementSelectedRequestHandler extends RequestHandler {

    /**
     * Returns true if the handler can dispatch the current request
     *
     * @param input input to the request handler
     * @param elementSelectedRequest ElementSelectedRequest request
     * @return true if the handler is capable of handling the current request and/or state
     */
    boolean canHandle(HandlerInput input, ElementSelectedRequest elementSelectedRequest);
     ...
     */
    Optional<Response> handle(HandlerInput input, ElementSelectedRequest elementSelectedRequest);
    ...
    default Optional<Response> handle(HandlerInput handlerInput) {
        return handle(handlerInput, (ElementSelectedRequest)handlerInput.getRequest());
    }
