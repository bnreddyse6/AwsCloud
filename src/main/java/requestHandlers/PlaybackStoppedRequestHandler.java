...
public interface PlaybackStoppedRequestHandler extends RequestHandler {
     ...
     */
    boolean canHandle(HandlerInput input, PlaybackStoppedRequest playbackStoppedRequest);
     ...
     */
    Optional<Response> handle(HandlerInput input, PlaybackStoppedRequest playbackStoppedRequest);
