...
public interface PreviousCommandIssuedRequestHandler extends RequestHandler {
     ...
     * @param previousCommandIssuedRequest PreviousCommandIssuedRequest request
     * @return true if the handler is capable of handling the current request and/or state
     */
    boolean canHandle(HandlerInput input, PreviousCommandIssuedRequest previousCommandIssuedRequest);
     ...
     */
    Optional<Response> handle(HandlerInput input, PreviousCommandIssuedRequest previousCommandIssuedRequest);
