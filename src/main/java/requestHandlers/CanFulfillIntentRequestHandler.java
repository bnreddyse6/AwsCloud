...
public interface CanFulfillIntentRequestHandler extends RequestHandler {
     ...
     */
    boolean canHandle(HandlerInput input, CanFulfillIntentRequest canFulfillIntentRequest);
     ...
     */
    Optional<Response> handle(HandlerInput input, CanFulfillIntentRequest canFulfillIntentRequest);
