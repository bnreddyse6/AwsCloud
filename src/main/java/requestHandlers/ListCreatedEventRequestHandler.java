...
public interface ListCreatedEventRequestHandler extends RequestHandler {
     ...
     * @param listCreatedEventRequest ListCreatedEventRequest request
     * @return true if the handler is capable of handling the current request and/or state
     */
    boolean canHandle(HandlerInput input, ListCreatedEventRequest listCreatedEventRequest);
     ...
     */
    Optional<Response> handle(HandlerInput input, ListCreatedEventRequest listCreatedEventRequest);
