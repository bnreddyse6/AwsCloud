 ...
 */
public interface NextCommandIssuedRequestHandler extends RequestHandler {

    /**
     * Returns true if the handler can dispatch the current request
     *
     * @param input input to the request handler
     * @param nextCommandIssuedRequest NextCommandIssuedRequest request
     * @return true if the handler is capable of handling the current request and/or state
     */
    boolean canHandle(HandlerInput input, NextCommandIssuedRequest nextCommandIssuedRequest);
     ...
     */
    Optional<Response> handle(HandlerInput input, NextCommandIssuedRequest nextCommandIssuedRequest);
    ...
    default Optional<Response> handle(HandlerInput handlerInput) {
        return handle(handlerInput, (NextCommandIssuedRequest)handlerInput.getRequest());
    }
